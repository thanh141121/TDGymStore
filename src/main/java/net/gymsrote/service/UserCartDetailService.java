...
//	}
	...
	public DataResponse<?> countByUser(Long idUser) {
		return  serviceUtils.convertToDataResponse(cartDetailRepo.countByUser(userRepo.getReferenceById(idUser)), Long.class);
	}
}
