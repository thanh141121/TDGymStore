...
import net.gymsrote.controller.advice.exception.AppException;
import net.gymsrote.controller.payload.request.LoginRequest;
...
public class AuthController {
    ...
    // UserEntity user = new UserEntity(signUpRequest.getFullname(), signUpRequest.getUsername(),
    // signUpRequest.getEmail(), signUpRequest.getPassword());
    //
    // user.setPassword(passwordEncoder.encode(user.getPassword()));
    //
    // RoleEntity userRole = roleRepository.findByName(EUserRole.ROLE_USER)
